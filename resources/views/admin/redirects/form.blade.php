...
@section('breadcrumb')
    ...
    <a href="{{ route('contensio.account.redirects.index') }}" class="text-gray-500 hover:text-gray-700">Redirects</a>
    <span class="mx-2 text-gray-300">/</span>
...
<div class="max-w-2xl mx-auto">
    ...
    <form method="POST"
          action="{{ $redirect->exists ? route('contensio.account.redirects.update', $redirect->id) : route('contensio.account.redirects.store') }}"
