...
<section class="theme-container pb-16">
    ...
    <div class="mb-6 flex items-start gap-3 bg-green-50 border border-green-200 text-green-800 rounded-lg px-4 py-3">
    ...
    <div class="mb-6 flex items-start gap-3 bg-red-50 border border-red-200 text-red-800 rounded-lg px-4 py-3">
        <svg class="w-5 h-5 shrink-0 mt-0.5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-gray-50 rounded-2xl border border-gray-200 p-6 sm:p-8">
        <h3 class="text-xl font-bold text-gray-900 mb-5">Leave a comment</h3>
        ...
        <form method="POST" action="{{ route('contensio.comments.store') }}" class="space-y-4">
            ...
            @auth
            <div class="flex items-center gap-3 py-3 px-4 bg-white border border-gray-200 rounded-lg text-gray-600">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block font-medium text-gray-700 mb-1.5">Name <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label class="block font-medium text-gray-700 mb-1.5">Email <span class="text-red-500">*</span></label>
                    <input type="email" name="author_email" value="{{ old('author_email') }}" required
                           class="w-full rounded-lg border border-gray-300 px-3 py-2.5
                                  focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent">
                    <p class="mt-1 text-gray-400">Your email won't be published.</p>
                    @error('author_email')
                    <p class="mt-1 text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div>
                <label class="block font-medium text-gray-700 mb-1.5">Comment <span class="text-red-500">*</span></label>
                <textarea name="body" rows="5" required
                          placeholder="Write your comment…"
                          class="w-full rounded-lg border border-gray-300 px-3 py-2.5 resize-y
