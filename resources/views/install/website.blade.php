...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
    ...
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">{{ __('contensio::install.website.title') }}</h1>
        <p class="text-gray-500 mt-1">{{ __('contensio::install.website.subtitle') }}</p>
    </div>
    ...
    <form method="POST" action="{{ route('contensio.install.website.store') }}" id="websiteForm">
        @csrf

        <div class="space-y-5">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('contensio::install.website.site_name') }}</label>
                <input type="text" name="site_name" value="{{ old('site_name') }}"
                    ...
                    placeholder="{{ __('contensio::install.website.site_name_placeholder') }}" autofocus>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('contensio::install.website.language') }}</label>
                ...
                <p class="text-gray-400 text-xs mt-1.5">{{ __('contensio::install.website.language_hint') }}</p>
            </div>
        </div>
